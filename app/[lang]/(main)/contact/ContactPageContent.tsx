          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-foreground">
                    {lang === 'ar' ? "اسم الشركة / المؤسسة" : "Company / Organization"} <span className="text-muted-foreground font-normal">(Optional)</span>
                  </label>
                  <input
                    type="text"
                    name="company"
                ...
                <div>
                  ...
                  <select name="service" className="w-full px-4 py-3 rounded-lg border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary/50">
                    <option value="">
