...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return generatePageMetadata("market_studies", lang as "en" | "ar", "services/market-studies");
}
...
export default async function MarketStudiesPage(props: ServicePageProps) {
  ...
  return (
    <main className="flex min-h-screen flex-col w-full text-start">
      ...
      <FinalCTA lang={lang} title={market_studies.cta.title} description={market_studies.cta.description} buttonLabel={market_studies.cta.button} border />
    </main>
  );
}
