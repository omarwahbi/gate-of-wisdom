...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return generatePageMetadata("performance_efficiency", lang as "en" | "ar", "services/performance-efficiency");
}
...
export default async function PerformanceEfficiencyPage(props: ServicePageProps) {
  ...
  const schemas = getPageJsonLd("performance_efficiency", lang, "services/performance-efficiency");
