...
const STORAGE_KEY = "gow_engineering_standards_submissions";
...
export function LeadMagnetModal({ lang }: LeadMagnetModalProps) {
  ...
  useEffect(() => {
    const handleDownloadClick = (e: Event) => {
      ...
      e.preventDefault();
      const standardData = button.getAttribute("data-standard");
      if (standardData) {
        setSelectedStandard(JSON.parse(standardData));
        setIsOpen(true);
    ...
    try {
      ...
      if (endpoint) {
        await fetch(endpoint, {
          ...
          body: new URLSearchParams({
            ...
            gift: selectedStandard ? `Engineering Standard #${selectedStandard.number}` : "Engineering Standards",
            lang,
            _host: window.location.hostname,
            _subject: "Gate of Wisdom - Engineering Standards Download",
          }),
        });
      }
      ...
      localStorage.setItem(
        ...
        JSON.stringify({
          ...
          gift: selectedStandard?.title || "Engineering Standards",
        })
      );
  ...
  const fileMap: Record<number, string> = {
    1: "01-iraq-guide-building-materials-2017.pdf",
    2: "02-public-safety-construction-projects-2017.pdf",
    3: "03-thermal-insulation-code-guidance-2024.pdf",
    4: "04-accessibility-building-requirements-2015.pdf",
    5: "05-engineering-ethics-code-2017.pdf",
    6: "06-loads-forces-code-2015.pdf",
    7: "07-foundations-retaining-walls-code-2015.pdf",
    8: "08-internal-lighting-code-2013.pdf",
    9: "09-natural-lighting-code-2013.pdf",
    10: "10-steel-construction-code-2015.pdf",
    11: "11-earthing-lightning-protection-code-2013.pdf",
    12: "12-water-supply-systems-buildings-code-2013.pdf",
    13: "13-air-conditioning-cooling-code-2015.pdf",
    14: "14-refrigeration-code-2015.pdf",
    15: "15-central-heating-code-2013.pdf",
    16: "16-natural-ventilation-sanitary-standards-code-2013.pdf",
    17: "17-mechanical-ventilation-code-2013.pdf",
    18: "18-scaffolding-code-2013.pdf",
    19: "19-sanitary-drainage-buildings-code-2017.pdf",
    20: "20-acoustics-code-2013.pdf",
    21: "21-thermal-insulation-code-2013.pdf",
    22: "22-waterproofing-code-2013.pdf",
    23: "23-earthquake-resistant-buildings-code-2017.pdf",
    24: "24-elevators-lifts-code-2014.pdf",
    25: "25-shelters-code-2015.pdf",
    26: "26-waste-management-code-2015.pdf",
    27: "27-fire-extinguishing-systems-code-2017.pdf",
    28: "28-urban-aesthetics-city-beautification-code-2017.pdf",
    29: "29-fire-protection-buildings-code-2013.pdf",
    30: "30-spatial-space-requirements-buildings-code-2013.pdf",
    31: "31-fire-detection-alarm-systems-code-2013.pdf",
    32: "32-hvac-refrigeration-systems-specs-2015.pdf",
    33: "33-sanitary-works-specs-2015.pdf",
    34: "34-electrical-works-specs-2015.pdf",
    35: "35-civil-works-specs-2017.pdf",
  };

  const content = {
    en: {
      title: "Download Engineering Standards",
      subtitle: "Get the complete Iraqi Building Codes & Technical Specifications",
      name: "Full Name",
      email: "Work Email",
    ...
    ar: {
      title: "تحميل المعايير الهندسية",
      subtitle: "احصل على مدونات البناء العراقية والمواصفات الفنية الكاملة",
      name: "الاسم الكامل",
        ...
        <div className="px-6 py-8 overflow-y-auto">
          {submitted ? (
            <div className="text-center space-y-6">
              ...
              <a
                href={`${process.env.NEXT_PUBLIC_CLOUDFLARE_R2_URL}/files/engineering-standards/${fileMap[selectedStandard!.number]}`}
                target="_blank"
