  ...
  return (
    <main className="flex min-h-screen flex-col w-full text-start">
      ...
      <PageHeader 
        ...
        bgImageUrl="https://images.unsplash.com/photo-1579532536935-619928decd08?q=80&w=2070&auto=format&fit=crop"
      />
      ...
      <section className="bg-muted py-16 md:py-24 border-y">
        <div className="container mx-auto px-4 max-w-6xl">
           <div className="mb-12 text-center max-w-3xl mx-auto">
             ...
             <p className="text-sm font-medium text-emerald-700 bg-emerald-100 dark:bg-emerald-900/30 dark:text-emerald-300 inline-block px-4 py-2 rounded-full mt-4 border border-emerald-200 dark:border-emerald-800">
