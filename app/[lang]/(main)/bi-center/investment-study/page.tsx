  ...
  return (
    <main className="flex min-h-screen flex-col w-full text-start">
      ...
      <PageHeader
        ...
        bgImageUrl="/images/bi-center/investment-study.jpg"
      />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {pageData.intro.axes.map((axis: any, i: number) => {
              const axisIcons = [TrendingUp, Scale, Building, BarChart2];
              const Icon = axisIcons[i] || Target;
              return (
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2 text-sm font-bold tracking-wider uppercase mb-6 shadow-sm">
              <Database className="h-4 w-4" /> {lang === 'ar' ? 'أصول المستثمر' : 'INVESTOR ASSETS'}
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {pageData.free_materials.items.map((item: any, i: number) => {
              const repIcons = [FileText, Search, Briefcase, Target];
      ...
      <ServiceGiftSection
        lang={lang}
        giftTitle={{
          en: "Investment Readiness Checklist",
          ar: "قائمة تدقيق الجاهزية الاستثمارية"
        }}
        giftDescription={{
          en: "Get Your Investment Readiness Checklist.",
          ar: "احصل على قائمة تدقيق الجاهزية الاستثمارية."
        }}
        downloadUrl={`${process.env.NEXT_PUBLIC_CLOUDFLARE_R2_URL}/files/bi-center-gifts/02-investment-readiness-checklist.pdf`}
        useEnvEndpoint={true}
        emailSubject={{
          en: "Gate of Wisdom - Investment Readiness Checklist",
          ar: "بوابة الحكمة - قائمة تدقيق الجاهزية الاستثمارية"
        }}
        emailMessage={{
          en: "Thank you for downloading the Investment Readiness Checklist. Please find the attachment below.",
          ar: "شكراً لتحميلك قائمة تدقيق الجاهزية الاستثمارية. تجد المرفق أدناه."
        }}
      />
