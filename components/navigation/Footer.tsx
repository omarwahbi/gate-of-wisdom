      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16 flex flex-col items-center justify-between gap-6 rounded-2xl bg-primary/5 p-8 md:flex-row md:px-12 border border-primary/10">
          <div className="flex-1 text-start">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Subscribe to our newsletter to receive the latest insights, news, and updates from Gate of Wisdom Consulting Engineers.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Consolidated Engineering & Management Services providing expert consulting with a vision for excellence and innovation across the region.
            </p>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start text-sm text-muted-foreground">
                ...
                <span>King Fahd Road, Al Olaya District<br/>Riyadh 12211, Saudi Arabia</span>
              </li>
              ...
              <li className="flex items-center text-sm text-muted-foreground">
                <Link href="mailto:info@gow.com.sa" className="hover:text-primary transition-colors">
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row text-sm text-muted-foreground">
          ...
          <div className="flex space-s-4">
            <Link href={`/${lang}/privacy`} className="hover:text-primary transition-colors">Privacy Policy</Link>
